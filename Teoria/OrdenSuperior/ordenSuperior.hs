{-
     -funciones que reciben funciones por parámetro o 
      bien devuelven una función como resultado.

     -La función filter recibe por parámetro 
      una función f y una lista 
      y retorna una nueva lista 
      que contiene aquellos elementos que al ser aplicados como parámetros 
      a f devuelven verdadero. 
       + La función f debe tener entonces aridad 1 y devolver un valor booleano.
      filter :: (a -> Bool) -> [a] -> [a]
